...
% trueLabelling=test_SL(2,:)-1;
% segLabelling=class_label(test_SL(1,:))'-1;
% labels=[1:no_classes];
...
%     a = sum(errorMatrix,2);
%     average_accuracy = (errorMatrix(i,i)./a(i,1))/length(labels)+average_accuracy;
%     
% end


% overall_accuracy = sum(diagVector)./sum(nrPixelsPerClass+eps);
